...
void FileSink::afterGettingFrame(unsigned frameSize,
    ...
    envir().taskScheduler().scheduleDelayedTask(10000,(TaskFunc *)FileSink::getNext,this);
}
void FileSink::getNext(void* firstArg)
{
    FileSink *fSink=(FileSink *)firstArg;
    fSink->continuePlaying();
}
