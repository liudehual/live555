...
#ifndef _LIVE_TS_SERVER_MEDIA_SUB_SESSION_HH
#define _LIVE_TS_SERVER_MEDIA_SUB_SESSION_HH
...
protected:
  ...
  virtual ~LiveTsServerSubSession();

  virtual ClientTrickPlayState1* newClientTrickPlayState();
...
class ClientTrickPlayState1 {
public:
  ClientTrickPlayState1(MPEG2TransportStreamIndexFile* indexFile);
